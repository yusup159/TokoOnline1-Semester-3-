<div class="container-fluid">
	...
	<div class="row text-center mt-4">
		<?php foreach ($anak_anak as $brg) : ?>

		<div class="card ml-3 mb-3" style="width: 16rem;">
		  <img src="<?php echo base_url().'/gambarmaul/'.$brg->gambar?>">
		  <div class="card-body">
		    <h5 class="card-title mb-1"><?php echo $brg->nama_brg ?></h5>
		    <p class="card-text"><?php echo $brg->keterangan ?></p>
		    <span class="badge badge-pill badge-succes mb-3">Rp.<?php echo number_format($brg->harga ,0 ,',','.')  ?></span>
